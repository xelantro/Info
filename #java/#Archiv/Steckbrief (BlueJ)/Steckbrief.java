public class Steckbrief implements Comparable<Steckbrief>
{
    // Attribute
     ...
     * this > s
     */
    public boolean compare(Steckbrief s)
    {
        return this.gibGewicht() > s.gibGewicht();
    }

    @Override
    public int compareTo(Steckbrief s) {
        if(this.gibGewicht() > s.gibGewicht())
            return 1;
        else if(this.gibGewicht() < s.gibGewicht())
            return -1;
        else
            return 0;
    }
