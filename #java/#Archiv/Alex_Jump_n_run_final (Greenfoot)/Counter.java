 ...
 * </pre>
 * 
 * @author alex(alles wo sufix drin vorkommt :D ) , Neil Brown and Michael Kölling (rest)
 * @version 1.0
 */
public class Counter extends GUI
{
     ...
     * Create a new counter, initialised to 0.
     */
    public Counter(String prefix,String sufix)
    {
        background = getImage();  // get image from class
        value = 0;
        target = 0;
    ...
    private void updateImage()
    {
        ...
        GreenfootImage text = new GreenfootImage(prefix + value + sufix, 22, Color.BLACK, transparent);
